...
var RedisStore = function(options) {
  ...
  this.incr = function(key, cb) {
    ...
    // If Redis fail, we want the requests to pass through
    if(options.passIfNotConnected && !options.client.connected) {
      console.warn("Redis is not connected: rate-limit-redis disabled !");
